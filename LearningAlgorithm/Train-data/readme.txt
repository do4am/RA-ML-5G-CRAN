...
The suffixes: 
 - Raw: raw dataset before clustering.
 - Merger: clustered using Merger algorithm.
 - NN: clustered based on the neareast neighbor positions. (there are reassignment of classees)
